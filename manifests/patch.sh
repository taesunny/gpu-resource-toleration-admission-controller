...
usage() {
    cat <<EOF
Generate certificate suitable for use with an gpu-resource-toleration-admission-controller service.
This script uses k8s' CertificateSigningRequest API to a generate a
certificate signed by k8s CA suitable for use with gpu-resource-toleration-admission-controller
...
The following flags are required.
       --service          Service name of gpu-resource-toleration-admission-controller.
       --namespace        Namespace where gpu-resource-toleration-admission-controller service and secret reside.
...
# patch gpu-resource-toleration-admission-controller.yaml
